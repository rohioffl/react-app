        ...
        findings.map((item, index) => (
          <div key={index} className="bg-white border border-gray-200 shadow rounded-lg p-6 mb-5">
            <div className="flex justify-between items-center">
              <div className="text-lg font-semibold text-blue-700">{item.details}</div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 text-sm text-gray-700">
              ...
              <div><strong>Resource:</strong> {item.resourceName}</div>
              <div><strong>Region:</strong> {item.region}</div>
              <div><strong>Service:</strong> {item.service}</div>
              <div><strong>Provider:</strong> {item.cloudProvider}</div>
